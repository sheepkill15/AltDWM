...
fn def_panel_bg() -> String { "#1e1e1e".into() }
fn def_panel_bg_top() -> String { "#252526".into() }
fn def_text() -> String { "#ffffff".into() }
fn def_text_dim() -> String { "#aaaaaa".into() }
fn def_accent() -> String { "#3a6ea5".into() }
fn def_accent_active() -> String { "#007acc".into() }
fn def_border() -> String { "#404040".into() }
fn def_tray_bg() -> String { "#2d2d30".into() }
fn def_font_name() -> String { "Segoe UI".into() }
fn def_font_size() -> i32 { 13 }
fn def_rounding() -> i32 { 6 }
fn def_gap() -> i32 { 8 }
...
impl Theme {
    ...
    pub fn panel_bg(&self, position: &str) -> COLORREF {
        if position == "top" { self.color(&self.panel_bg_top) } else { self.color(&self.panel_bg) }
    }
    pub fn text_color(&self) -> COLORREF { self.color(&self.text) }
    pub fn text_dim_color(&self) -> COLORREF { self.color(&self.text_dim) }
    pub fn accent_color(&self) -> COLORREF { self.color(&self.accent) }
    pub fn accent_active_color(&self) -> COLORREF { self.color(&self.accent_active) }
    pub fn border_color(&self) -> COLORREF { self.color(&self.border) }
}
